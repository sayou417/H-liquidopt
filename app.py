...
def project_report_markdown(
    ...
    if final_decision:
        lines += [
            ...
            f"- Calculated rack internal pressure drop: {float(final_decision.get('rack_dp_kpa', 0.0)):.2f} kPa",
            f"- Rack pressure-drop basis: {final_decision.get('rack_dp_basis', 'Not available')}",
...
if phase == 1:
    ...
    # ===================================
    # APPROVED PHASE 4 NETWORK BASIS
    # ===================================
    phase5_geometry = (
        st.session_state.get(
            "phase4_geometry"
